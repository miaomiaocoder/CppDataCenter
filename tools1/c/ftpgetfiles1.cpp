...
int main(int argc, char const *argv[])
{
    ...
    // 遍历容器vfilelist。
    // for (int ii = 0; ii < vlisfile.size(); ++ii)
    // {
...
void _help()
{
    ...
    printf("Sample:/project/tools1/bin/procctl 30 /project/tools1/bin/ftpgetfiles /log/idc/ftpgetfiles_surfdata.log \"<host>127.0.0.1:21</host><mode>1</mode><username>ren</username><password>renpwd</password><localpath>/idcdata/surfdata</localpath><remotepath>/tmp/idc/surfdata</remotepath><matchname>SURF_ZH*.XML,SURF_ZH*.CSV</matchname>\"\n\n\n");
