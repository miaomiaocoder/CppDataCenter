...
int main(int argc, char *argv[])
{
    if (argc != 3)
    {
        ...
        printf("Sample:./inetd /tmp/inetd.log /project/etc/inetd.conf\n\n");
        printf("        /project/tools1/bin/procctl 5 /project/tools1/bin/inetd /tmp/inetd.log /project/etc/inetd.conf\n\n");
        return -1;
    }
