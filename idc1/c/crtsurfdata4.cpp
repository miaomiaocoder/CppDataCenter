/*
 *程序名：crtsurfdata4.cpp 本程序用于生成全国气象站点观察的分钟数据。
 *作者：任振华。
*/
...
int main(int argc, char *argv[])
{
    ...
    if(argc!=5)
    {
        cout<<"Using:./crtsurfdata4 inifile outpath logfile datafmt"<<endl;
        cout<<"Example:/project/idc1/bin/crtsurfdata4 /project/idc1/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata4.log xml,json,csv"<<endl<<endl;
        ...
        cout<<"datafmt 生成数据文件的格式, 支持xml、json和csv三种格式, 中间用逗号分隔。"<<endl<<endl;
