/*
 *程序名：crtsurfdata5.cpp 本程序用于生成全国气象站点观察的分钟数据。
 *作者：任振华。
 */
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 5)
    {
        cout << "Using:./crtsurfdata5 inifile outpath logfile datafmt" << endl;
        cout << "Example:/project/idc1/bin/crtsurfdata5 /project/idc1/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata5.log xml,json,csv" << endl
             << endl;
